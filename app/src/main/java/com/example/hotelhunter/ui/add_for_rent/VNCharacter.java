...
public class VNCharacter {
    private static final char[] VIETNAM = {
    ...
    private static final char[] ASCII = {
            ...
            'a', 'a', 'a', 'a', 'e', 'e', 'e', 'i', 'i', 'o', 'o', 'o', 'o', 'u', 'u', 'y',
            'A', 'a', 'D', 'd', 'I', 'i', 'U', 'u', 'O', 'o', 'U', 'u', 'A', 'a', 'A', 'a',
            'A', 'a', 'A', 'a', 'A', 'a', 'A', 'a', 'A', 'a', 'A', 'a', 'A', 'a', 'A', 'a',
            'A', 'a', 'A', 'a', 'E', 'e', 'E', 'e', 'E', 'e', 'E', 'e', 'E', 'e', 'E', 'e',
            'E', 'e', 'E', 'e', 'I', 'i', 'I', 'i', 'O', 'o', 'O', 'o', 'O', 'o', 'O', 'o',
            'O', 'o', 'O', 'o', 'O', 'o', 'O', 'o', 'O', 'o', 'O', 'o', 'O', 'o', 'O', 'o',
            'U', 'u', 'U', 'u', 'U', 'u', 'U', 'u', 'U', 'u', 'U', 'u', 'U', 'u'
    };

    public static char removeAccent(char charVN) {
        int index = Arrays.binarySearch(VIETNAM, charVN);
        if (index >= 0) {
            charVN = ASCII[index];
        }
        return charVN;
    ...
    public static String removeAccent(String str) {
        ...
        for (int i = 0; i < builder.length(); i++) {
            builder.setCharAt(i, removeAccent(builder.charAt(i)));
        }
